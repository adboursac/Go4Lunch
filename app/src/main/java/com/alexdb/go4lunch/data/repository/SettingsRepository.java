...
public class SettingsRepository {
     ...
     */
    public static Preferences.Key<Integer> KEY_MAP_ZOOM = PreferencesKeys.intKey("map_zoom");
    public static final Integer DEFAULT_MAP_ZOOM = 18;
     ...
     */
    public static final Preferences.Key<Integer> KEY_SEARCH_RADIUS = PreferencesKeys.intKey("search_radius");
    public static final Integer DEFAULT_SEARCH_RADIUS = 200;
     ...
     */
    public static final Preferences.Key<Boolean> KEY_LUNCH_NOTIFICATION = PreferencesKeys.booleanKey("lunch_notification");
    ...
    public <T> void readValue(Preferences.Key<T> key,
                              T defaultValue,
                              MutableLiveData<T> liveData) {
        Flowable<T> dataFlow = mDataStore.data()
        ...
        Disposable disposable = dataFlow.subscribe(liveData::postValue,
